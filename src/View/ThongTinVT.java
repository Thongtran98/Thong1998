...
import static Controller.NOIvethang.rsvt;
 ...
 * @author nguye
 */
public class ThongTinVT extends javax.swing.JFrame {
    ...
    public void refreshTable(){
        noiVeThang.selectVeThang();
        TableVT.setModel(DbUtils.resultSetToTableModel(rsvt));
        TableVT.setEnabled(false);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CHI TIẾT VÉ THÁNG");
        ...
        TableVT.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã vé", "Họ tên", "Mã xe", "Loại xe", "Số tiền", "Ngày làm", "Ngày hết"
            }
        ));
        jScrollPane1.setViewportView(TableVT);

        nhapTimKiem.setText("VT");
    ...
    private void nhapTimKiemKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nhapTimKiemKeyReleased
        // TODO add your handling code here:
        try{
            String query ="select MaVe,HoTen,MaXe,LoaiXe,GiaVe,NgayLam,NgayHet from VeThang where MaVe LIKE ?";
            PreparedStatement pst = conn.prepareStatement(query);
            pst.setString(1, nhapTimKiem.getText()+"%");
            ResultSet rsvd = pst.executeQuery();
            TableVT.setModel(DbUtils.resultSetToTableModel(rsvd));
            TableVT.setEnabled(false);
            pst.close();
        }catch(Exception ex){
            ex.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThongTinVT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThongTinVT().setVisible(true);
            }
        });
    }
